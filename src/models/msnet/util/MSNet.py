...
class MSNet(TrainableLayer):
    ...
    def layer_op(self, images, is_training):
        ...
        downsample1 = ConvolutionalLayer(
            self.base_chns[0],
            kernel_size=[1, 3, 3],
            stride=[1, 2, 2],
            padding="SAME",
        ...
        downsample2 = ConvolutionalLayer(
            self.base_chns[1],
            kernel_size=[1, 3, 3],
            stride=[1, 2, 2],
            padding="SAME",
        ...
        pred_up2_1 = DeconvolutionalLayer(
            self.num_classes * 2,
            kernel_size=[1, 3, 3],
            stride=[1, 2, 2],
            padding="SAME",
        ...
        pred_up2_2 = DeconvolutionalLayer(
            self.num_classes * 2,
            kernel_size=[1, 3, 3],
            stride=[1, 2, 2],
            padding="SAME",
        ...
        pred_up3_1 = DeconvolutionalLayer(
            self.num_classes * 4,
            kernel_size=[1, 3, 3],
            stride=[1, 2, 2],
            padding="SAME",
        ...
        pred_up3_2 = DeconvolutionalLayer(
            self.num_classes * 4,
            kernel_size=[1, 3, 3],
            stride=[1, 2, 2],
            padding="SAME",
...
class ResBlock(TrainableLayer):
    ...
    def layer_op(self, input_tensor, is_training):
        ...
        for i in range(len(self.kernels)):
            ...
            bn_op = BNLayer(regularizer=self.regularizers["w"], name="bn_{}".format(i))
            acti_op = ActiLayer(
                func=self.acti_func,
...
if __name__ == "__main__":
    x = tf.compat.v1.placeholder(tf.float32, shape=[1, 96, 96, 96, 1])
    y = tf.compat.v1.placeholder(tf.float32, shape=[1, 96, 96, 96, 2])
