...
def format_config_data(input_dir, results_dir, example_names=None):
    """This method formats information about data into a dictionary."""
    return {
        "data_root": input_dir,
        "save_folder": results_dir,
        "data_names": example_names,
        "modality_postfix": ["flair", "t1", "t1ce", "t2"],
        "file_postfix": "nii.gz",
    }


def parse_config(filename, input_dir, results_dir, example_names):
    ...
    output["data"] = format_config_data(input_dir, results_dir, example_names)
    return output
